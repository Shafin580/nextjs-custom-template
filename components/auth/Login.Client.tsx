...
import { useLoading } from "../global/Loader/Loader-Context";
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              {passwordFieldType == "password" ? (
                <Eye
                  className="absolute top-3 right-4 h-4 w-4 text-gray-400"
                  onClick={() => {
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/dashboard/forgot-password" className="text-sm underline">
                Forgot your password?
              </Link>
            </div>
            {loginErrorMessage && <p className="mt-1 text-xs text-red-500">{loginErrorMessage}</p>}
          </div>
